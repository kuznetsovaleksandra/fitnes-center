...
var startSliders = function startSliders() {
  if (document.querySelector('.coaches__slider')) {
    var coachsWrapper = document.querySelector('.coaches__swiper-wrapper');
    var coachsButtonPrev = document.querySelector('.coaches__slider-button-prev');
    var coachsButtonNext = document.querySelector('.coaches__slider-button-next');
...
var buttons = document.querySelectorAll('.subscription__title-item');
var tabs = document.querySelectorAll('.subscription__list');
